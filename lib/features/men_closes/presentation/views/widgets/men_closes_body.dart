...
class MenClosesBody extends StatefulWidget {
  const MenClosesBody({super.key});

  @override
  State<MenClosesBody> createState() => _MenClosesBodyState();
}

class _MenClosesBodyState extends State<MenClosesBody> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              ...
              width: double.infinity,
              child: GestureDetector(
                onTap: () => Navigator.pushNamed(context, 'closesdetailsview'),
