...
class PrivateOrderBody extends StatefulWidget {
  const PrivateOrderBody({super.key});

  @override
  State<PrivateOrderBody> createState() => _PrivateOrderBodyState();
}

class _PrivateOrderBodyState extends State<PrivateOrderBody> {
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                ...
                style:
                    AppTextStyle.regular16.copyWith(color: AppColors.orderColor),
              ),
            ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      isChecked
                          ? Navigator.pushNamed(
                              context, 'privateOrderDetailsView')
                          : showDialog(
                              context: context,
